        ...
        results = (service.files()
            .list(
                ...
                q="""
                    ...
                    and mimeType != 'application/vnd.google-apps.shorcut'
                    and '191519R@student.hci.edu.sg' in owners
                """,
                fields="files(id, name, quotaBytesUsed, mimeType, parents)"
            )
            .execute()
        )
        files = results["files"]
